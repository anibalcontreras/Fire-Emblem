...
public class FirstAttackPercentageComparisionDamageReductionEffect : IFirstAttackPercentageDamageReductionEffect
{
    private readonly EffectTarget _target;
    private readonly double _maxPercentage = 0.6;
    ...
    public void ApplyEffect(Unit activator, Unit opponent)
    {
        ...
        targetUnit.ApplyFirstAttackPercentageDamageReduction(percentageReduction);
    ...
    {
        double percentageReduction = statDifference * 0.06;
